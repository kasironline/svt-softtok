	...
	if (!_xnext_included && !window.location.href.match(/fb_xd_fragment/g)) {
			...
			var e = b.documentElement,
				...
				B = function (a) {
					...
					return function (a) {
						...
						(a = !0 === a) && (g = 33),
							b ||
								((b = !0), (d = e - (f.now() - c)), d < 0 && (d = 0), a || d < 9 ? i() : k(i, d));
					};
				},
				C = function (a) {
					var b,
		...
		(function () {
					...
					if (injectRosettaRetry < 10) {
						...
						if (!!window.Ecwid && !!window.Ecwid.logException) {
							window.Ecwid.logException(
								'Failed to load translations. Url: ' + url + '. retry number: ' + injectRosettaRetry
							);
						}
					}
				};
			...
			tryInjectRosettaScript(
				'https://d3cy3u1txmkqs3.cloudfront.net/rosetta/translations2022/new-frontend/files/new-frontend.id.421083682.js',
				'https://d201eyh6wia12q.cloudfront.net/translations2022/new-frontend/files/new-frontend.id.421083682.translations'
			);
		})();
		(function () {
			window.ecwid_init_elm_config = function () {
				function load() {
					...
					script.src = selectJsVersion(
						'https://d3cy3u1txmkqs3.cloudfront.net/venera/static/ecwid-storefront.fb2136e053c19958b94602513f2981a3.min.js'
					);
					document.getElementsByTagName('head')[0].appendChild(script);
				}
				function loadCheckout(callback) {
					...
					script.src = selectJsVersion(
						'https://d3cy3u1txmkqs3.cloudfront.net/venera/static/ecwid-checkout.0049404163d5b61accee02442becac53.min.js'
					);
					document.getElementsByTagName('head')[0].appendChild(script);
		...
		window.Ecwid = {
			...
			MessageBundles:
				window.Ecwid && window.Ecwid.MessageBundles ? window.Ecwid.MessageBundles : {},
			restoreCartData:
				window.Ecwid && window.Ecwid.restoreCartData ? window.Ecwid.restoreCartData : {},
			ExtensionPoint: ep,
					...
					var incompatibleScriptCheckFunctions = [
						...
						function checkForWeeblyUnresponsiveTheme() {
							var useUnresponsiveTheme =
								isScriptLoadedByName('main-mobile.js') && typeof Weebly != 'undefined';
			...
			_injectEcwidCss: function () {
				...
				cssUrlAddition += isNewDefaultFontForProductBrowser()
					? '&useNewDefaultFontForProductBrowser'
					: '';
				...
				function isIOS13() {
					...
					var uaSimilarToIos =
						/Version\/13/.test(ua) &&
						(/iPad/.test(ua) || /iPod/.test(ua) || /iPhone/.test(ua) || /Intel Mac OS X/.test(ua));
				...
				window.ec_legacyCssUrl =
					'https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=1583849773&ownerid=224387&withoutLegacyCss=true' +
					cssUrlAddition;
				var cssUrl =
					'https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=1583849773&ownerid=224387&withoutLegacyCss=true' +
					cssUrlAddition;
				...
				var ecwidCssLoadedTimer = setInterval(function () {
					try {
						if (
							...
							(/interactive/.test(document.readyState) && Ecwid._isAllCssLoaded())
						) {
...
<div class="ecwid-pb-placeholder__product"></div><div class="ecwid-pb-placeholder__title"><div></div><div></div><div></div></div>\
			...
			_onBodyDone: function () {
				if (
					...
					ru_cdev_xnext_frontend_LegacyFrontend = function () {
						var U = 'bootstrap',
							V = 'begin',
							W = 'gwt.codesvr.ru.cdev.xnext.frontend.LegacyFrontend=',
							X = 'gwt.codesvr=',
							Y = 'ru.cdev.xnext.frontend.LegacyFrontend',
							Z = 'startup',
							$ = 'DUMMY',
							_ = 0,
							ab = 1,
							...
							nb = 'function',
							ob = 'javascript',
							pb = 'ru_cdev_xnext_frontend_LegacyFrontend',
							qb = 'Failed to load ',
							rb = 'moduleStartup',
							sb = 'scriptTagAdded',
							tb = 'moduleRequested',
							ub = 'meta',
							vb = 'name',
							wb = 'ru.cdev.xnext.frontend.LegacyFrontend::',
							xb = '::',
							yb = 'gwt:property',
							zb = 'content',
							Ab = '=',
							...
							Kb = 'clear.cache.gif',
							Lb = 'baseUrl',
							Mb = 'ru.cdev.xnext.frontend.LegacyFrontend.nocache.js',
							Nb = 'base',
							Ob = '//',
							Pb = 'user.agent',
							Qb = 'webkit',
							...
							hc = 'ru.cdev.xnext.frontend.LegacyFrontend.devmode.js',
							ic = '3266047C494255EF926D35FFACE3AE0B',
							jc = '421916520541D195F7889D15AC16C11D',
							kc = '6059393F7977F8CB3DD6A958CCE58225',
							lc = '7C9EE7B68CFB9F663D8887CEE3B781AB',
							mc = 'F53FFA350F97237240CB02D4E9DBF9B2',
							nc = ':',
							oc = '.cache.js',
							pc = 'loadExternalRefs',
							qc = 'end',
							...
							tc = 'file:',
							uc = '_gwt_dummy_',
							vc = '__gwtDevModeHook:ru.cdev.xnext.frontend.LegacyFrontend',
						...
						ru_cdev_xnext_frontend_LegacyFrontend.__sendStats = s;
						ru_cdev_xnext_frontend_LegacyFrontend.__moduleName = Y;
						ru_cdev_xnext_frontend_LegacyFrontend.__errFn = null;
						ru_cdev_xnext_frontend_LegacyFrontend.__moduleBase = $;
						ru_cdev_xnext_frontend_LegacyFrontend.__softPermutationId = _;
						ru_cdev_xnext_frontend_LegacyFrontend.__computePropValue = null;
						ru_cdev_xnext_frontend_LegacyFrontend.__getPropMap = null;
						ru_cdev_xnext_frontend_LegacyFrontend.__installRunAsyncCode = function () {};
						ru_cdev_xnext_frontend_LegacyFrontend.__gwtStartLoadingFragment = function () {
							return null;
						};
						ru_cdev_xnext_frontend_LegacyFrontend.__gwt_isKnownPropertyValue = function () {
							return false;
						};
						ru_cdev_xnext_frontend_LegacyFrontend.__gwt_getMetaProperty = function () {
							return null;
						};
						var t = null;
						var u = (p.__gwt_activeModules = p.__gwt_activeModules || {});
						u[Y] = { moduleName: Y };
						ru_cdev_xnext_frontend_LegacyFrontend.__moduleStartupDone = function (e) {
							var f = u[Y].bindings;
							u[Y].bindings = function () {
								var a = f ? f() : {};
								var b = e[ru_cdev_xnext_frontend_LegacyFrontend.__softPermutationId];
						...
						function C(f) {
							...
							function h(a) {
								...
								d.language = ob;
								d.src = a;
								if (ru_cdev_xnext_frontend_LegacyFrontend.__errFn) {
									d.onerror = function () {
										ru_cdev_xnext_frontend_LegacyFrontend.__errFn(pb, new Error(qb + a));
									};
								}
								c.appendChild(d);
								s(rb, sb);
						...
						ru_cdev_xnext_frontend_LegacyFrontend.__startLoadingFragment = function (a) {
							return H(a);
						};
						ru_cdev_xnext_frontend_LegacyFrontend.__installRunAsyncCode = function (a) {
							var b = w();
							var c = b.body;
							var d = b.createElement(mb);
							if (typeof ecwid_addCspNonceToScript === nb) {
						...
						function H(a) {
							...
							return ru_cdev_xnext_frontend_LegacyFrontend.__moduleBase + a;
						}
						function I() {
							var f = [];
							var g = _;
							...
							ru_cdev_xnext_frontend_LegacyFrontend.__getPropMap = function () {
								var a = {};
								for (var b in j) {
							...
							ru_cdev_xnext_frontend_LegacyFrontend.__computePropValue = l;
							p.__gwt_activeModules[Y].bindings =
								ru_cdev_xnext_frontend_LegacyFrontend.__getPropMap;
							s(U, gc);
							if (r()) {
								return H(hc);
							}
							...
							ru_cdev_xnext_frontend_LegacyFrontend.__softPermutationId = g;
							return H(m + oc);
						}
						function J() {
						...
						F();
						ru_cdev_xnext_frontend_LegacyFrontend.__moduleBase = G();
						u[Y].moduleBase = ru_cdev_xnext_frontend_LegacyFrontend.__moduleBase;
						var K = I();
						if (p) {
							var L = !!(
						...
						function R(b) {
							...
							var d = setInterval(function () {
								if (!c) {
									...
									var a = document
										.getElementById(ru_cdev_xnext_frontend_LegacyFrontend.__moduleName)
						...
						function T() {
							document.getElementById(ru_cdev_xnext_frontend_LegacyFrontend.__moduleName).remove();
		...
		xInjectJs(
			'https://d3dq8sxcny4hg.cloudfront.net/states.js?version=2023-1286-gdb2079a079a836&callback=window.ecwid_states_data.loaded'
		);
		...
		window.ecwid_script_base =
			'https://d3cy3u1txmkqs3.cloudfront.net/static/br/2023-1286-gdb2079a079a836/';
		...
		window.xnext_ownerId = 224387;
		(window.Ecwid.publicToken = 'public_kFxt3PpYQjLK45bywRpqrFhQ6FRb1RjU'),
			(window.Ecwid.demo = false);
		window.Ecwid.cssUrl =
			'https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=1583849773&ownerid=224387&withoutLegacyCss=true';
		window.Ecwid.acceptLanguage = ['id'];
		...
		(function () {
			...
			var ecDataJsBaseUrl = 'https://app.ecwid.com/data.js?ownerid=224387';
			ecDataJsBaseUrl += '&lang=id';
			ecDataJsBaseUrl += '&token=7dd4193f40c698842f0b2978a7800f239bdad35f';
		...
		window.Ecwid.getAppPublicToken = function (namespace) {
			var tokenMap = {
				'custom-app-224387-1': 'public_EAQbGnfLgWfAHbwj1bbumWVVXfLsxzqe',
				xendit: 'public_H853WfSAAQpwCcLNMmeptD9NzCY5eknA',
				'ecwid-storefront': 'public_kFxt3PpYQjLK45bywRpqrFhQ6FRb1RjU'
			};
...
window.Ecwid.getAppPublicConfig = function (namespace) {
	var publicData = {
		...
		'ecwid-storefront': '{}',
		'starter-site': '{}',
		'ecwid-cpsettings-app': '{}',
		'ecwid-degenerator-app': '{}',
		'ecwid-startersite-app': '{}'
	};
